...
class MakeStream:
    ...
    def condense_points(self, dwell_list, radius, density_threshold = .01, calculate_new_time=True, layer_plot=False):
        """
        ...
        for n in range(len(dwell_list)):
            ...
            # if (n==layer_plot):
            #     self.plot_cluster(points, labels, clusters, centroids_in_layer)    
    ...
    def dither_stream(self, rad, sigma, filename, dwell_time_max_ms = 3.5):
        ...
        outfile = f"{filename}_{rad:.0f}_{sigma:.0f}.str"
    ...
    def create_condensed_stream(self, output_file, dither_rad, sigma):
        self.dither_stream(dither_rad, sigma, output_file)
